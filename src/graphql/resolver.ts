...
import { generateTrackingNumber, uploadFileToAmazons3,generateOrderNumber, uploadFileToSupabaseS3 } from "./lib/aws.js";
...
export const resolvers = {
  Query: {
    readPrivacy: async (parent_: any, args_: any) => {
        try {
    ...
    readDisclaimer : async (parent_: any, args_: any) => {
      try {
    ...
    readAbout: async (parent_: any, args_: any) => {
      try {
    ...
    readFAQ: async (parent_: any, args_: any) => {
      try {
    ...
    readActiveUsers: async (parent_: any, args: any, context: any) => {
      try {
    ...
    readNewsManagement: async (parent_: any, args: any) =>{
        try {
    ...
    readGroupedOrderHistory: async (parent_: any, args: any) => {
      const result = await prisma.orderHistory.findMany({
        distinct: ['TrackingNo'], // Use distinct instead of groupBy
        where:{
    ...
    readGroupedOrderHistoryRecieved: async (parent_: any, args: any) => {
      const result = await prisma.orderHistory.findMany({
        distinct: ['TrackingNo'], // Use distinct instead of groupBy
        where:{
          agentEmail:args.emailAddress,
    ...
    readGroupedOrderHistoryPacked: async (parent_: any, args: any) => {
      const result = await prisma.orderHistory.findMany({
        distinct: ['TrackingNo'], // Use distinct instead of groupBy
        where:{
          agentEmail:args.emailAddress,
    ...
    readGroupedOrderHistoryLogistic: async (parent_: any, args: any) => {
      const result = await prisma.orderHistory.findMany({
        distinct: ['TrackingNo'], // Use distinct instead of groupBy
        where:{
          agentEmail:args.emailAddress,
    ...
    readGroupedOrderHistoryDelivery: async (parent_: any, args: any) => {
      const result = await prisma.orderHistory.findMany({
        distinct: ['TrackingNo'], // Use distinct instead of groupBy
        where:{
          agentEmail:args.emailAddress,
    ...
    readGroupedOrderHistoryDelivered: async (parent_: any, args: any) => {
      const result = await prisma.orderHistory.findMany({
        distinct: ['TrackingNo'], // Use distinct instead of groupBy
        where:{
          agentEmail:args.emailAddress,
    ...
    getGroupedOrderHistory: async (parent_: any, args: any) => {
      const result = await prisma.orderHistory.findMany({
        distinct: ['TrackingNo'], // Use distinct instead of groupBy
        where:{
    ...
    getGroupedOrderHistoryRecieved: async (parent_: any, args: any) => {
      const result = await prisma.orderHistory.findMany({
        distinct: ['TrackingNo'], // Use distinct instead of groupBy
        where:{
          emailAddress:args.emailAddress,
    ...
    getGroupedOrderHistoryPacked: async (parent_: any, args: any) => {
      const result = await prisma.orderHistory.findMany({
        distinct: ['TrackingNo'], // Use distinct instead of groupBy
        where:{
          emailAddress:args.emailAddress,
    ...
    getGroupedOrderHistoryLogistic: async (parent_: any, args: any) => {
      const result = await prisma.orderHistory.findMany({
        distinct: ['TrackingNo'], // Use distinct instead of groupBy
        where:{
          emailAddress:args.emailAddress,
    ...
    getGroupedOrderHistoryDelivery: async (parent_: any, args: any) => {
      const result = await prisma.orderHistory.findMany({
        distinct: ['TrackingNo'], // Use distinct instead of groupBy
        where:{
          emailAddress:args.emailAddress,
    ...
    getGroupedOrderHistoryDelivered: async (_parent: any, args: any) => {
      const result = await prisma.orderHistory.findMany({
        distinct: ['TrackingNo'], // Use distinct instead of groupBy
        where:{
          emailAddress:args.emailAddress,
    ...
    getOrderHistory: async (_parent?: any, args?: any) => {
      try {
    ...
    getInv_subImage: async (_parent?: any, args?: any) => {
      try {
    ...
    getChildInventory: async (_parents: any, args: any) => {
      try {
    ...
    personalMessages: async (parent?: any, args?: any) =>{
      try {
    ...
    readGroupSender: async (parent?: any, args?: any) =>{
      try {
        const messages = await prisma.personalMessages.findMany({
            where:{
              Sender:args.emailAddress
